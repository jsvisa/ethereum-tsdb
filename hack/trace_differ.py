...
pdev AS (
    SELECT
        ...
        a.txpos AS a_txpos,
        b.txpos AS b_txpos,
        a.from_address AS a_from_address,
        b.from_address AS b_from_address,
        a.to_address AS a_to_address,
        b.to_address AS b_to_address,
        a.value AS a_value,
        b.value AS b_value,
        a.input AS a_input,
        b.input AS b_input,
        a.output AS a_output,
        b.output AS b_output,
        CASE a.trace_type WHEN 'create2' THEN 'create' ELSE a.trace_type END AS a_trace_type,
        b.trace_type AS b_trace_type,
        a.call_type AS a_call_type,
        b.call_type AS b_call_type,
        a.reward_type AS a_reward_type,
        b.reward_type AS b_reward_type,
        COALESCE(a.gas, -1) AS a_gas,
        COALESCE(b.gas, -1) AS b_gas,
        COALESCE(a.gas_used, -1) AS a_gas_used,
        COALESCE(b.gas_used, -1) AS b_gas_used,
        a.subtraces AS a_subtraces,
        b.subtraces AS b_subtraces,
        a.trace_address AS a_trace_address,
        b.trace_address AS b_trace_address,
        a.error AS a_error,
        b.error AS b_error,
